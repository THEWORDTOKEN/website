            ...
            <div className="max-wrapper__content faqs margin-top">
                ...
                <div className='faqs__content'>
                    <div class="faqs__content--accordion">
                        <h3 class="faqs__content--accordion-title">What is The Word Token?  <span class="material-icons">add</span></h3>
                    ...
                    <div class="faqs__content--accordion">
                        <h3 class="faqs__content--accordion-title">How can I Buy The Word Token?  <span class="material-icons">add</span></h3>
                        <div class="faqs__content--accordion-content">
                    ...
                    <div class="faqs__content--accordion">
                        <h3 class="faqs__content--accordion-title">What is the use case of The Word Token?<span class="material-icons">add</span></h3>
                        <div class="faqs__content--accordion-content">
                    ...
                    <div class="faqs__content--accordion">
                        <h3 class="faqs__content--accordion-title">Has ownership been renounced?  <span class="material-icons">add</span></h3>
                        <div class="faqs__content--accordion-content">
                            <p>YES</p>
                        </div>
                    </div>
                    <div class="faqs__content--accordion">
                        <h3 class="faqs__content--accordion-title">What is the market cap prediction by the end of 2024?  <span class="material-icons">add</span></h3>
                        <div class="faqs__content--accordion-content">
                            <p>$1 Billion</p>
                        </div>
                    </div>
                    <div class="faqs__content--accordion">
                        <h3 class="faqs__content--accordion-title">How can I stake my $TWD Tokens?  <span class="material-icons">add</span></h3>
                        <div class="faqs__content--accordion-content">
                            <p>Coming soon</p>
                        </div>
                    </div>
                    <div class="faqs__content--accordion">
                        <h3 class="faqs__content--accordion-title">When will the read to earn application be launched?  <span class="material-icons">add</span></h3>
                        <div class="faqs__content--accordion-content">
                            <p>May 2024</p>
                        </div>
                    </div>
                    <div class="faqs__content--accordion">
                        <h3 class="faqs__content--accordion-title">How can I access the project's white paper?  <span class="material-icons">add</span></h3>
                        <div class="faqs__content--accordion-content">
                            <p>GoTo <a href="https://thewordtoken.com/">https://thewordtoken.com/</a></p>
                        </div>
                    </div>
                    <div class="faqs__content--accordion">
                        <h3 class="faqs__content--accordion-title">How can I Partner or volunteer to join the team?  <span class="material-icons">add</span></h3>
                        <div class="faqs__content--accordion-content">
                            <p><a href="admin@thewordtoken.com">admin@thewordtoken.com</a></p>
                        </div>
                    </div>
                    <div class="faqs__content--accordion">
                        <h3 class="faqs__content--accordion-title">How do I join the community?  <span class="material-icons">add</span></h3>
                        <div class="faqs__content--accordion-content">
                    ...
                    <div class="faqs__content--accordion">
                        <h3 class="faqs__content--accordion-title">Still need some more answers? <span class="material-icons">add</span></h3>
                        <div class="faqs__content--accordion-content">
                        <p>GoTo <a href="https://thewordtoken.com/">https://thewordtoken.com/</a></p>
                        </div>
                    </div>
